...
namespace ErkinStudy.Web.Controllers.Admin
{
    public class UniversityController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Title,About")] University university)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Title,About")] University university)
        {
            if (id != university.Id)
            {
                return NotFound();
