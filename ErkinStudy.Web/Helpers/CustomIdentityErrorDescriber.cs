...
namespace ErkinStudy.Web.Helpers
{
    public class CustomIdentityErrorDescriber : IdentityErrorDescriber
    {
        ...
        public override IdentityError PasswordMismatch() { return new IdentityError { Code = nameof(PasswordMismatch), Description = "Пароль қате терілді." }; }
        public override IdentityError InvalidToken() { return new IdentityError { Code = nameof(InvalidToken), Description = "Код қате." }; }
        ...
        public override IdentityError InvalidEmail(string email) { return new IdentityError { Code = nameof(InvalidEmail), Description = $"Email '{email}' қате терілді." }; }
        ...
        public override IdentityError DuplicateEmail(string email) { return new IdentityError { Code = nameof(DuplicateEmail), Description = $"'{email}' Email-ымен бұған дейін басқа адам тіркелген." }; }
